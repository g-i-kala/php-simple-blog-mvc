...
<div class="page__container flex flex-col justify-center items-center">
    ...
    <div class="form__wrapper my-4">
        ...
        <?php displayError($errors, 'general') ?>
        <?php displayError($errors, 'session') ?>
        ...
        <form action="/register" method="POST" id="registration-form" class="form__reglog flex flex-col">
            ...
            <input type="text" id="username" name="username"
                class="input__field border-1 border-blue-500 rounded-md px-2 py-1"
            ...
            <input type="password" id="password" name="password"
                class="input__field border-1 border-blue-500 rounded-md px-2 py-1" minlength="1" maxlength="50"
                required>
          
            <?php displayError($errors, 'password') ?>

            <button type="submit" id="register" name="register"
                class="btn size-fit self-center my-4 px-4 py-1 border-1 border-blue-400 bg-blue-400 hover:bg-blue-200 rounded-md hover:cursor-pointer">Register</button>
            <div>
                <p>You already have an account? </p>
                <a href='/login' class="link size-fit self-center my-4  py-1 text-blue-400 hover:text-blue-700 "> Log In
                </a>
            </div>
        </form>
    </div>
